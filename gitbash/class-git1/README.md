...
git log --graph --oneline --decorate --all #Visualiza el historial de commits de forma visual y resumida, incluyendo todas las ramas...//
git log -3 #Limitamos el número de commits.

git log --after=“2018-1-2” #Muestra los comits realizados despues de esa fecha...///

git log --after=“today”  #Muestra solo los commits realizados desde hoy en adelante...//
...
cd Tecnicatura #Ingreso a la carpeta con ese nombre...//

cd class-git #Ingreso a la carpeta con ese nombre...//
...
Es la herramienta que usás para instalar librerías externas
...
Busca la librería en internet
La descarga
La instala en tu entorno
🧩 ¿Qué son esas “librerías”?

Son código ya hecho por otros programadores, por ejemplo:

requests → para hacer llamadas a APIs 🌐
numpy → cálculos matemáticos 🔢
pandas → manejo de datos 📊
flask → crear páginas web 🌍

👉 En vez de programar todo desde cero, usás pip
...
👉 Lo que estás haciendo es actualizar la herramienta misma

🔹 Razones importantes
1. 🛠️ Corrección de errores

Versiones viejas pueden fallar

2. 🔒 Seguridad

Las versiones nuevas son más seguras

3. ⚡ Compatibilidad

Algunas librerías nuevas NO funcionan con pip viejo

4. 🚀 Mejor rendimiento

Descarga e instala más rápido

🧠 Ejemplo claro

👉 Si tenés un pip viejo:

❌ puede fallar al instalar algo moderno

👉 Con pip actualizado:

✔️ todo funciona mejor

📌 Resumen corto (para que lo puedas estudiar)

👉 pip es la herramienta que permite instalar librerías en Python.
👉 Se actualiza para evitar errores, mejorar seguridad y asegurar compatibilidad con paquetes nuevos.

💬 Forma tipo respuesta de examen

Podés decir algo así:

pip es el gestor de paquetes de Python que permite instalar, actualizar y administrar librerías externas. Se actualiza para garantizar compatibilidad con nuevas librerías, mejorar la seguridad, corregir errores y optimizar su funcionamiento.

Si querés, te ayudo a armar todas las respuestas del práctico final bien redactadas 👨‍💻📘
